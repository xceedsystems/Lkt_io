...
#define LEGALCOPYRIGHT          "Copyright y2k ahkait, Inc."
...
#define PRODUCT_BUILD_NUMBER    3                               // Nonzero if engineering or alpha/beta release
#define PRODUCT_VERSION         "6.0 Build 3" OPTION_STR	    // last chg 5/10/99
#define PRODUCT_NAME            "LKT I/O Driver"
...
// GUI version info
#ifdef _DEBUG
#define FILE_NAMEEXT            "LKT_IO.IO3"      // if you are using MFC, add the suffix 'D'
#else
#define FILE_NAMEEXT            "LKT_IO.IO3"
#endif
