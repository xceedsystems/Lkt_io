...
#define IDS_FLATCODE_BASE               0                           /* We may want the base set to 0, 
                                                                                  to preserve the manufacturer's error codes */
                                                              
#define IDS_FLATCODE_HW_TEST            ( IDS_FLATCODE_BASE + 1 )   /* Hardware test failed                                  */
#define IDS_FLATCODE_INVALID_ADDERSS    ( IDS_FLATCODE_BASE + 2 )   /* Address is out of range                               */
#define IDS_FLATCODE_DEVICE_OFFLINE     ( IDS_FLATCODE_BASE + 3 )   /* Address points to an offline device                   */
#define IDS_FLATCODE_TIMEOUT            ( IDS_FLATCODE_BASE + 4 )   /* Timeout error for this function                       */
#define IDS_FLATCODE_READ_SIZE          ( IDS_FLATCODE_BASE + 5 )   /* Read  buffer too short                                */
#define IDS_FLATCODE_WRITE_SIZE         ( IDS_FLATCODE_BASE + 6 )   /* Write buffer too short                                */
#define IDS_FLATCODE_RW_ZERO            ( IDS_FLATCODE_BASE + 7 )   /* Zero bytes to be transferred                          */
#define IDS_FLATCODE_DPR_OUT            ( IDS_FLATCODE_BASE + 8 )   /* Out of DPR image                                      */
