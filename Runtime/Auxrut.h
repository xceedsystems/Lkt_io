...
void	InCardCopy(PVOID pDest, PVOID pSource, UINT32 Size,UINT32 dType,UINT32 IOSwap);
void	OutCardCopy(PVOID pDest, PVOID pSource, UINT32 Size,UINT32 dType,UINT32 IOSwap);         
void	ZeroCardCopy(PVOID pDest, PVOID pSource, UINT32 Size,UINT32 dType);         
